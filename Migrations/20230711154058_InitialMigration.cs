        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeAdress = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderAmount = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 7, 11, 18, 40, 57, 947, DateTimeKind.Local).AddTicks(3453)),
                    OrderAddress = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false, defaultValue: "г.Караганда ул.Пушкина д.Колотушкина 105")
                },
                constraints: table =>
                {
